<script setup>
    ...
    import questionsSecondPart from '../Questions/theoretical-two.json'
</script>
...
<script>
    export default {
        ...
        mounted() {
            document.title = "Examen Teórico 2"
        }
    }
</script>
...
<template>
    ...
    <div class="d-block m-2">
        <div class="d-flex justify-content-center">
            <Question :qst="questionsSecondPart" testType="teorico-2" @getQntQuestions="getQuantityQuestions($event)"></Question>
        </div>
    </div>
</template>
